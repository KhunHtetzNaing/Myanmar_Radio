...
public class shwe extends Activity implements B4AActivity{
	public static shwe mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmradio", "com.htetznaing.mmradio.shwe");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (shwe).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmradio", "com.htetznaing.mmradio.shwe");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmradio.shwe", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (shwe) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (shwe) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (shwe) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _height = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.Title = \"Shwe FM\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Shwe FM"));
 //BA.debugLineNum = 21;BA.debugLine="Dim h As String";
_h = "";
 //BA.debugLineNum = 22;BA.debugLine="h = File.ReadString(File.DirAssets,\"Shwe\")";
_h = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Shwe");
