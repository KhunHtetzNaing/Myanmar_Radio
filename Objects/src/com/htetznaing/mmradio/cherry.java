...
public class cherry extends Activity implements B4AActivity{
	public static cherry mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmradio", "com.htetznaing.mmradio.cherry");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (cherry).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmradio", "com.htetznaing.mmradio.cherry");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmradio.cherry", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (cherry) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (cherry) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (cherry) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _height = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.Title = \"Cherry FM\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Cherry FM"));
 //BA.debugLineNum = 21;BA.debugLine="Dim h As String";
_h = "";
 //BA.debugLineNum = 22;BA.debugLine="h = File.ReadString(File.DirAssets,\"cherry\")";
_h = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"cherry");
...
public static String  _b_adscreendismissed() throws Exception{
 //BA.debugLineNum = 70;BA.debugLine="Sub B_AdScreenDismissed";
 //BA.debugLineNum = 71;BA.debugLine="Log(\"B Dismissed\")";
...
public static String  _b_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 62;BA.debugLine="Sub B_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 63;BA.debugLine="Log(\"B failed: \" & ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("B failed: "+_errorcode);
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public static String  _b_receivead() throws Exception{
 //BA.debugLineNum = 66;BA.debugLine="Sub B_ReceiveAd";
 //BA.debugLineNum = 67;BA.debugLine="Log(\"B received\")";
...
public static String  _n_adscreendismissed() throws Exception{
 //BA.debugLineNum = 58;BA.debugLine="Sub N_AdScreenDismissed";
 //BA.debugLineNum = 59;BA.debugLine="Log(\"N Dismissed\")";
...
public static String  _n_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 51;BA.debugLine="Sub N_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 52;BA.debugLine="Log(\"N failed: \" & ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("N failed: "+_errorcode);
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public static String  _n_receivead() throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub N_ReceiveAd";
 //BA.debugLineNum = 55;BA.debugLine="Log(\"N received\")";
