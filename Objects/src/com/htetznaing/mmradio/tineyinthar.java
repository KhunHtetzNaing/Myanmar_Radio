...
public class tineyinthar extends Activity implements B4AActivity{
	public static tineyinthar mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmradio", "com.htetznaing.mmradio.tineyinthar");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tineyinthar).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmradio", "com.htetznaing.mmradio.tineyinthar");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmradio.tineyinthar", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tineyinthar) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tineyinthar) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (tineyinthar) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _height = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.Title = \"Tine Yin Thar\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Tine Yin Thar"));
 //BA.debugLineNum = 21;BA.debugLine="Dim h As String";
_h = "";
 //BA.debugLineNum = 22;BA.debugLine="h = File.ReadString(File.DirAssets,\"Tineyinthar\")";
_h = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Tineyinthar");
...
b4a.util.BClipboard _copy = null;
 //BA.debugLineNum = 81;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 82;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 83;BA.debugLine="Dim copy As BClipboard";
_copy = new b4a.util.BClipboard();
 //BA.debugLineNum = 84;BA.debugLine="copy.clrText";
_copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 85;BA.debugLine="copy.setText(\"မိမိတို႔ဖုန္းကေနတဆင့္ ျမန္မာေရဒီယို";
_copy.setText(mostCurrent.activityBA,"မိမိတို႔ဖုန္းကေနတဆင့္ ျမန္မာေရဒီယိုလိုင္းမ်ား 'အခမဲ့' နားဆင္နိုင္တဲ့ Myanmar Radio App ေလးပါ။"+anywheresoftware.b4a.keywords.Common.CRLF+"ပါဝင္ေသာ ေရဒီယိုလိုင္းမ်ားမွာ..."+anywheresoftware.b4a.keywords.Common.CRLF+"ခ်ယ္ရီ FM"+anywheresoftware.b4a.keywords.Common.CRLF+"မႏၲေလး FM"+anywheresoftware.b4a.keywords.Common.CRLF+"ေရႊ FM"+anywheresoftware.b4a.keywords.Common.CRLF+"ပတၱျမား FM"+anywheresoftware.b4a.keywords.Common.CRLF+"MRTV"+anywheresoftware.b4a.keywords.Common.CRLF+"သစၥာပါရမီ"+anywheresoftware.b4a.keywords.Common.CRLF+"တိုင္းရင္းသား"+anywheresoftware.b4a.keywords.Common.CRLF+"Download Free at here : http://www.myanmarandroidapp.com/search?q=Myanmar+Radio+App");
 //BA.debugLineNum = 86;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 87;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 88;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(_copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 89;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 90;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 91;BA.debugLine="StartActivity (ShareIt)";
