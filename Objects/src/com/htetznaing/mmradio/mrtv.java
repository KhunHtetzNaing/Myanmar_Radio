...
public class mrtv extends Activity implements B4AActivity{
	public static mrtv mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmradio", "com.htetznaing.mmradio.mrtv");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (mrtv).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmradio", "com.htetznaing.mmradio.mrtv");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmradio.mrtv", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (mrtv) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (mrtv) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (mrtv) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
int _height = 0;
 ...
 //BA.debugLineNum = 20;BA.debugLine="Activity.Title = \"MRTV\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("MRTV"));
 //BA.debugLineNum = 21;BA.debugLine="Dim h As String";
_h = "";
 //BA.debugLineNum = 22;BA.debugLine="h = File.ReadString(File.DirAssets,\"MRTV\")";
_h = anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"MRTV");
